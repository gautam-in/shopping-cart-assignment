    ...
    <>
      ...
      >
        <ul
          ...
          onClick={(e) => {
            return setprodType(e.target.getAttribute("value"));
          }}
        >
          <li value="">All</li>
          <hr />
        ...
        <div style={{ gridColumn: "2/6" }}>
          ...
          >
            {prod
              .filter((pr) => {
                return prodType ? pr.category == prodType : pr;
              })
              .map((pd, index) => {
                return (
      ...
      >
        <select
          id="dropdown"
          style={{ width: "65%", backgroundColor: "#D70040", color: "white" }}
          onChange={(e) => {
            return setprodType(e.target.value);
          }}
        >

...
const Product=({product,addToCart})=>{
    let {name,imageURL,description,price}=product;
    return <div className={css.Product}>
                ...
                <div className={css.Footer}><span className={css.Price}>MRP Rs.{price}</span> <span><Button onClick={()=>addToCart(product)}>Buy Now</Button></span></div>
                <div className={css.FooterMobile}><Button small onClick={()=>addToCart(product)}>Buy Now@Rs.{price}</Button></div>
            </div>
}
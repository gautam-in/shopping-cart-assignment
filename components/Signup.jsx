...
export default function Signup() {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      if (validatePasswords(passwordRef.current.value, confirmPasswordRef.current.value)) {
    ...
    <div className={styles.SignupContainer} data-testid="signup-form">
      <form onSubmit={handleSubmit}>
        ...
        <FormControl>
          ...
          <Input type="password" id="password_id_confirm" ref={confirmPasswordRef} isRequired />
        </FormControl>
      ...
      <Text fontSize="xl" align="center">
        ...
        <Link href="/login" passHref>
          <Text color="blue" display="inline" fontWeight="bold" cursor="pointer"> Login</Text>
        </Link>
      </Text>
    </div>
  );

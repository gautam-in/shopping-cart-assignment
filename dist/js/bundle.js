...
"use strict";
eval("\n\nvar _Messages = __webpack_require__(/*! ./models/Messages */ \"./src/js/models/Messages.js\");\n\nvar _base = __webpack_require__(/*! ./routes/base */ \"./src/js/routes/base.js\");\n\nvar _Common = __webpack_require__(/*! ./models/Common */ \"./src/js/models/Common.js\");\n\nvar _base2 = __webpack_require__(/*! ./views/base */ \"./src/js/views/base.js\");\n\nvar _mainPageView = __webpack_require__(/*! ./views/mainPageView */ \"./src/js/views/mainPageView.js\");\n\nvar _loginView = __webpack_require__(/*! ./views/loginView */ \"./src/js/views/loginView.js\");\n\nvar _signupView = __webpack_require__(/*! ./views/signupView */ \"./src/js/views/signupView.js\");\n\nvar _ProductsView = __webpack_require__(/*! ./views/ProductsView */ \"./src/js/views/ProductsView.js\");\n\nvar _messageView = __webpack_require__(/*! ./views/messageView */ \"./src/js/views/messageView.js\");\n\nvar _loaderView = __webpack_require__(/*! ./views/loaderView */ \"./src/js/views/loaderView.js\");\n\nvar _carouselView = __webpack_require__(/*! ./views/carouselView */ \"./src/js/views/carouselView.js\");\n\n/** Global state of the app\r\n  =>Message\r\n  =>Routes\r\n */\n\n\n// Views Imports\n\n\n// Routes Imports\nvar state = {};\n\n/**\r\n * Routes Registration\r\n */\n\n\n// Common Functionalities Imports\n// Models Imports\nvar registerRoutes = function registerRoutes() {\n  if (!state.routes) {\n    state.routes = _base.routes;\n  }\n  _base.routes.mainPage.addEventListener('click', function (e) {\n    // Load Login View\n    console.log(_base.routes.mainPage);\n    (0, _carouselView.renderCarousel)(true);\n    (0, _mainPageView.renderMainPage)();\n  });\n  _base.routes.login.addEventListener('click', function (e) {\n    // Load Login View\n    (0, _carouselView.renderCarousel)(false);\n    (0, _loginView.renderLogin)();\n    loginController();\n  });\n\n  _base.routes.signup.addEventListener('click', function (e) {\n    // Load Register View\n    (0, _carouselView.renderCarousel)(false);\n    (0, _signupView.renderSignup)();\n    signUpController();\n  });\n\n  _base.routes.products.addEventListener('click', function (e) {\n    // Load Products View\n    (0, _carouselView.renderCarousel)(false);\n    (0, _ProductsView.renderProducts)();\n  });\n};\n\n/**\r\n * Message Registration\r\n */\nvar registerMessages = function registerMessages() {\n  if (!state.notify) {\n    state.notify = _Messages.messages;\n  }\n};\n\nvar loginController = function loginController() {\n  if (!state.loginPage) {\n    state.loginPage = {};\n  }\n\n  _base2.elements.loginPage.submitButton.addEventListener('click', function (e) {\n    // Validate Inputs\n    if (!(0, _Common.validateEmail)(_base2.elements.loginPage.userNameInput.value)) {\n      // Show Email Message\n      (0, _messageView.renderMessage)(state.notify.failure.selector, state.notify.failure.login.invalidEmail, _base2.elements.loginPage.userNameInput);\n    } else if (!(0, _Common.validateBlank)(_base2.elements.loginPage.passwordInput.value)) {\n      // Show Password Message\n      (0, _messageView.renderMessage)(state.notify.failure.selector, state.notify.failure.login.passwordBlank, _base2.elements.loginPage.userForm);\n    } else {\n      // console.log(validateEmail(elements.loginPage.userNameInput.value) && validateBlank(elements.loginPage.passwordInput.value));\n      (0, _loaderView.renderFakeLoader)(true, 3, _mainPageView.renderMainPage);\n    }\n  });\n  // console.log(elements.loginPage.userNameInput);\n};\n\nvar signUpController = function signUpController() {\n  if (!state.signUpPage) {\n    state.signUpPage = {};\n  }\n\n  _base2.elements.signUpPage.submitButton.addEventListener('click', function (e) {\n    // Validate Inputs\n    if (!(0, _Common.validateEmail)(_base2.elements.signUpPage.email.value)) {\n      // Show Email Message\n      (0, _messageView.renderMessage)(state.notify.failure.selector, state.notify.failure.signUp.invalidEmail, _base2.elements.signUpPage.userForm);\n    } else if (!(0, _Common.validateBlank)(_base2.elements.signUpPage.firstNameInput.value) || !(0, _Common.validateBlank)(_base2.elements.signUpPage.lastNameInput.value)) {\n      // Show Password Message\n      (0, _messageView.renderMessage)(state.notify.failure.selector, state.notify.failure.signUp.formMandatory, _base2.elements.signUpPage.userForm);\n    } else if (!(0, _Common.validateBlank)(_base2.elements.signUpPage.password.value) || !(0, _Common.validateBlank)(_base2.elements.signUpPage.confirmPassword.value)) {\n      (0, _messageView.renderMessage)(state.notify.failure.selector, state.notify.failure.signUp.passwordBlank, _base2.elements.signUpPage.userForm);\n    } else if (!(0, _Common.passwordCriteria)(_base2.elements.signUpPage.password.value) || (0, _Common.spaceCheck)(_base2.elements.signUpPage.password.value)) {\n      (0, _messageView.renderMessage)(state.notify.failure.selector, state.notify.failure.signUp.passwordCriteria, _base2.elements.signUpPage.userForm);\n    } else if (_base2.elements.signUpPage.password.value != _base2.elements.signUpPage.confirmPassword.value) {\n      (0, _messageView.renderMessage)(state.notify.failure.selector, state.notify.failure.signUp.passwordMismatch, _base2.elements.signUpPage.userForm);\n    } else {\n      (0, _messageView.renderMessage)(state.notify.success.selector, state.notify.success.signUp, _base2.elements.signUpPage.userForm);\n      (0, _loaderView.renderFakeLoader)(true, 3, _mainPageView.renderMainPage);\n    }\n  });\n  // console.log(elements.loginPage.userNameInput);\n};\n\n// Initialize Application\nvar initApp = function () {\n  registerRoutes();\n  registerMessages();\n  (0, _carouselView.renderCarousel)(true);\n  (0, _mainPageView.renderMainPage)();\n}();\n\n//# sourceURL=webpack:///./src/js/index.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.persistData = exports.spaceCheck = exports.passwordCriteria = exports.validateBlank = exports.validateEmail = undefined;\n\nvar _base = __webpack_require__(/*! ../views/base */ \"./src/js/views/base.js\");\n\nvar validateEmail = exports.validateEmail = function validateEmail(inputString) {\n  var emailPattern = new RegExp(_base.elements.validators.emailPattern);\n  if (emailPattern.test(inputString)) {\n    return true;\n  } else {\n    return false;\n  }\n};\n\nvar validateBlank = exports.validateBlank = function validateBlank(inputString) {\n  if (inputString != _base.elements.validators.blankPattern) {\n    return true;\n  } else {\n    return false;\n  }\n};\n\nvar passwordCriteria = exports.passwordCriteria = function passwordCriteria(inputString) {\n  var passwordPattern = new RegExp(_base.elements.validators.passwordCriteriaPattern);\n  if (passwordPattern.test(inputString)) {\n    return true;\n  } else {\n    return false;\n  }\n};\n\nvar spaceCheck = exports.spaceCheck = function spaceCheck(inputString) {\n  var spacePattern = new RegExp(_base.elements.validators.spacePattern);\n  if (spacePattern.test(inputString)) {\n    return true;\n  } else {\n    return false;\n  }\n};\n\nvar persistData = exports.persistData = function persistData() {\n  localStorage.setItem('likes', JSON.stringify(undefined.likes));\n};\n\n// export const readStorage = () {\n//   // const storage = JSON.parse(localStorage.getItem('likes'));\n//   //\n//   // // Restoring likes from the localStorage\n//   // if (storage) this.likes = storage;\n// };\n\n//# sourceURL=webpack:///./src/js/models/Common.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.XHRLoader = exports.renderFakeLoader = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/views/base.js\");\n\nvar renderFakeLoader = exports.renderFakeLoader = function renderFakeLoader(show, time, pageToView) {\n  time = time * 1000;\n\n  if (show) {\n    console.log(_base.elements.loader);\n    _base.elements.loader.style.display = 'block';\n    setTimeout(function () {\n      _base.elements.loader.style.display = 'none';\n      pageToView();\n    }, time);\n  }\n};\n\nvar XHRLoader = exports.XHRLoader = function XHRLoader(show, time, pageToView) {\n  time = time * 1000;\n\n  if (show) {\n    console.log(_base.elements.loader);\n    _base.elements.loader.style.display = 'block';\n    setTimeout(function () {\n      _base.elements.loader.style.display = 'none';\n      pageToView();\n    }, time);\n  }\n};\n\n//# sourceURL=webpack:///./src/js/views/loaderView.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.renderMessage = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/views/base.js\");\n\nvar _Messages = __webpack_require__(/*! ../models/Messages */ \"./src/js/models/Messages.js\");\n\nvar renderMessage = exports.renderMessage = function renderMessage(type, message, element) {\n\n  var markup = '\\n    <div id=\"message-box\" class=\"%%message-box-class%%\">\\n    <span class=\"closebtn\" onclick=\"this.parentElement.style.display=\\'none\\';\">x</span>\\n  <strong> %%message%% </strong>\\n  </div>\\n    ';\n  markup = markup.replace('%%message%%', message);\n  switch (type) {\n    case _Messages.messages.success.selector:\n      markup = markup.replace('%%message-box-class%%', _Messages.messages.success.cssSelector);\n      break;\n\n    case _Messages.messages.failure.selector:\n      markup = markup.replace('%%message-box-class%%', _Messages.messages.failure.cssSelector);\n      break;\n    case _Messages.messages.warning.selector:\n      markup = markup.replace('%%message-box-class%%', _Messages.messages.warning.cssSelector);\n      break;\n    case _Messages.messages.info.selector:\n      markup = markup.replace('%%message-box-class%%', _Messages.messages.info.cssSelector);\n      break;\n\n  };\n\n  var messageElement = document.querySelector('#message-box');\n\n  if (messageElement) {\n    messageElement.parentNode.removeChild(messageElement);\n    element.insertAdjacentHTML('beforebegin', markup);\n  } else {\n    element.insertAdjacentHTML('beforebegin', markup);\n  }\n};\n\n//# sourceURL=webpack:///./src/js/views/messageView.js?");

...
export interface ProductInterface  { name: string, imageURL: string; description: string; price: number; stock: number; category: string; sku: string; id: string; };
...
const Products = () =>{
    const [products, setProducts] = useState<ProductInterface[]>(AllProducts)

...
const SignUpPage = () => {
  ...
  const validator = (field, value, compareValue) => {
    switch (field) {
      case 'email':
        const emailRegex =
          /^[a-zA-Z0-9]+([._+-][a-zA-Z0-9]+)*@[0-9a-zA-Z]+.[a-zA-Z]{2,4}([.][a-zA-Z]{2,4})?$/gm;
      ...
      case 'password':
        ...
        if (value.includes(' '))
          return 'Passowrd shoud not contain space character.';
      ...
      <section className={classes.container}>
        ...
        >
          ...
          <label className={classes.inputLabel}>
            ...
            {!!error['email'] && (
              <p className={classes.inputError} id='emailError'>
                &#9888; {error['email']}
              </p>
            )}
          </label>
          ...
          <label className={classes.inputLabel}>
            ...
            {!!error['password'] && (
              <p className={classes.inputError} id='passwordError'>
                &#9888; {error['password']}
              </p>
            )}
          </label>
          ...
          <label className={classes.inputLabel}>
            ...
            {!!error['confirmPassword'] && (
              <p className={classes.inputError} id='confirmPasswordError'>
                &#9888; {error['confirmPassword']}
              </p>
            )}
          </label>

          <button type='submit' className={classes.registrationButton}>
            Signup
          </button>
        </form>
      </section>

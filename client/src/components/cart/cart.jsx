...
function Cart({ setCart }) {
    ...
    function confirmOrder(){ 
        ...
        setTimeout(()=>{setConfrm(false); setCart(false);dispatch(handlecartupdate());},3000)
    ...
    return (
        <div  onClick={close} className="container">
            {confirm&&<div className={"dialog"}>
                <div>
                    <h2>
                     Thank you for shopping !!! </h2>

                     </div>
                </div>}
            <div style={{height:"600px"}} onClick={(e) => e.stopPropagation()} className="cart">
                <header>

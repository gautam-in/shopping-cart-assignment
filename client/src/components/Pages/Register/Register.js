...
export default function Register() {
  ...
  const { firstName, lastName, email, password, confirmPassword, error } = singupInfo;
  ...
  const handleSubmit = (event) => {
    ...
    const { firstName, lastName, email, password, confirmPassword} = singupInfo;
    ...
    <div className="register">
      ...
      <div className="signupForm">
        ...
        <div className='form-group'>
          ...
          <button type='submit' className="registerBtn form-group">
            Sign Up
          </button>
        </form>
      </div>

...
describe("should load leftNav component", () => {
    test('render all left Nav Categories', () => {
    ...
    test('render particular categories on click of selected category', () => {
        ...
        const linkItem = container.querySelectorAll(".nav-link")
        console.log("linkitemssssss", linkItem[0])
        fireEvent.click(linkItem[0])
        // fireEvent.change(linkItem[0], {
        //     target: {

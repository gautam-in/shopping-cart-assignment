                ...
                <div className="card-body bg-grey">
                    {props.cartItems && props.cartItems.map((item) => (
                        <div className="row  bg-white ">
                            <div className="col-2"><img className="img-fluid" alt="" src={item.imageURL} /></div>
                            <div className="col-7">
                    ...
                    <div className="row my-3 bg-white">
                        <div className="col m-auto"><img className='img-fluid' alt="" src="static/images/lowest-price.png"></img></div>

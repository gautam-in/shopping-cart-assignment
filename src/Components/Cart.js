...
function Cart(props) {
    ...
    const [ itemCountVal, setItemCountVal] = useState(1)
    console.log({cartList}, props, "cart");
    useEffect(()=> {
        let totalAmount = 0;
                    ...
                    <div className="modal">
                        ...
                        <div className="CartContent">
                            ...
                            <div className='ContentTag'>
                                <img src={lowPriceImg} alt="Lowest price image" width="100px"/>

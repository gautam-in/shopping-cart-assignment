        ...
        <section className={classes['signup-container']}>
            ...
            <form onSubmit={submitHandler} className={classes['signup-form']}>
                ...
                <div className="floating-label">
                    ...
                    <div className={emailError ? classes.errorMessage : classes['errorMessage-null']}>{emailError}</div>
                </div>
                ...
                <div className="floating-label">
                    ...
                    <div className={passwordError ? classes.errorMessage : classes['errorMessage-null']}>{passwordError}</div>
                </div>

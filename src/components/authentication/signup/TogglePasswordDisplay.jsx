...
const TogglePasswordDisplay = ({setFormaData, id, formData, setError}) => {
  ...
  return (
    <div className = "relative">
         <input type = {`${togglePasswordDisplay ? "text" : "password"}`} id = {id} className = "login-form-input" onChange = { passwordChangeHandler}/>

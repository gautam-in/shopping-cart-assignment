...
function setTabIndexAriaLabel() {
    document.querySelectorAll('.product-card__name, .product-card__detail--description, .product-card__buy--price').forEach(el => el.setAttribute('tabindex', 0));
...
function loadProductsBasedOnSelection(obj) {
    ...
    Object.keys(obj).forEach((key) => {
        ...
        productCardBuyPriceDiv.classList.add('flex-row', 'product-card__buy--price');

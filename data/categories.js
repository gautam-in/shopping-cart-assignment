module.exports = [
  {
    ...
    enabled: true,
    order: 1,
    imageUrl: '/resources/img/category/fruits.png',
  ...
  },
  {
    ...
    enabled: true,
    order: 2,
    imageUrl: '/resources/img/category/bakery.png',
  ...
  },
  {
    ...
    enabled: true,
    order: 3,
    imageUrl: '/resources/img/category/beverages.png',
...

  {
    ...
    enabled: true,
    order: 4,
    imageUrl: '/resources/img/category/beauty.png',
  ...
  },
  {
    ...
    enabled: true,
    order: 5,
    imageUrl: '/resources/img/category/baby.png',
